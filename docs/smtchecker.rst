...
However, other solvers, such as Eldarica, prefer the actual precise operations
syntactically as well.
The CLI option ``--model-checker-div-mod-slack`` and the JSON option
``settings.modelChecker.divModWithSlacks`` can be used to toggle the encoding
